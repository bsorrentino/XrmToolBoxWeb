...
export const WhoAmIRequest = () => 
    WebApiClient.Execute<WhoAmIResponse>(WebApiClient.Requests.WhoAmIRequest) as Promise<WhoAmIResponse>

export interface RetrieveAllEntitiesResponse {
    EntityMetadata: Array<Xrm.Metadata.EntityMetadata>
    Timestamp: String
}
export const RetrieveAllEntities = ( params: { EntityFilters:EntityFiltersEnum, RetrieveAsIfPublished:Boolean}) => { 
    ...
    return WebApiClient.Execute<RetrieveAllEntitiesResponse>(req) as Promise<RetrieveAllEntitiesResponse>
}
